...
public static class HealthCheckConfig
{
    ...
    //    .AddHealthCheckSqlServer(config.SqlServerConnectionString(), name: "Sql Server")
    //    //.AddHealthCheckRabbitMQ(rabbitConnection, config, name: "RabbitMQ")
    //    //.AddRedis(config.RedisConnectionString().Replace("redis://", ""), "Redis", HealthStatus.Degraded)
    //    .AddCheck<GCInfoHealthCheck>("GC");
    //}

    //public static void UseHealthCheckConfiguration(this IApplicationBuilder app)
    //{
    //    app.UseHealthChecks("/cleanarchitecture/v1/health/live", new HealthCheckOptions()
    //    {
    //        Predicate = _ => true,
    //        ResponseWriter = WriteResponse
    //    });
    //    app.UseHealthChecks("/cleanarchitecture/v1/health/ready", new HealthCheckOptions()
    //    {
    ...
    //public static IHealthChecksBuilder AddHealthCheckSqlServer
    //    (
    //        this IHealthChecksBuilder builder,
    ...
    //        Action<SqlServerConnection> beforeOpenConnectionConfigurer = default
    //    ) =>
    //    builder.AddHealthCheckSqlServer(_ => connectionString, healthQuery, name, failureStatus, tags, timeout, beforeOpenConnectionConfigurer);

    //private static IHealthChecksBuilder AddHealthCheckSqlServer
    //(
    //  this IHealthChecksBuilder builder,
    ...
    //    var hc = new HealthCheckRegistration(
    //        name ?? "mysql",
    //        sp => new SqlServerHealthCheck(connectionStringFactory(sp), healthQuery ?? "SELECT 1;", beforeOpenConnectionConfigurer),
    //        failureStatus,
    //        tags,
    //        timeout);
